...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD COUNT_ALL_CALCULATED AS (
    ISNULL(DAY_1_ALL, 0) +  ISNULL(DAY_2_ALL, 0)  + ISNULL(DAY_3_ALL, 0)  + ISNULL(DAY_4_ALL, 0)  + ISNULL(DAY_5_ALL, 0)  + ISNULL(DAY_6_ALL, 0)  + ISNULL(DAY_7_ALL, 0)  + 
    ISNULL(DAY_8_ALL, 0) +  ISNULL(DAY_9_ALL, 0)  + ISNULL(DAY_10_ALL, 0) + ISNULL(DAY_11_ALL, 0) + ISNULL(DAY_12_ALL, 0) + ISNULL(DAY_13_ALL, 0) + ISNULL(DAY_14_ALL, 0) + 
    ISNULL(DAY_15_ALL, 0) + ISNULL(DAY_16_ALL, 0) + ISNULL(DAY_17_ALL, 0) + ISNULL(DAY_18_ALL, 0) + ISNULL(DAY_19_ALL, 0) + ISNULL(DAY_20_ALL, 0) + ISNULL(DAY_21_ALL, 0) + 
    ISNULL(DAY_22_ALL, 0) + ISNULL(DAY_23_ALL, 0) + ISNULL(DAY_24_ALL, 0) + ISNULL(DAY_25_ALL, 0) + ISNULL(DAY_26_ALL, 0) + ISNULL(DAY_27_ALL, 0) + ISNULL(DAY_28_ALL, 0) + 
    ISNULL(DAY_29_ALL, 0) + ISNULL(DAY_30_ALL, 0) + ISNULL(DAY_31_ALL, 0)
);
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD COUNT_PERFORM_CALCULATED AS (
    ISNULL(DAY_1_PERFORM, 0)  + ISNULL(DAY_2_PERFORM, 0)  + ISNULL(DAY_3_PERFORM, 0)  + ISNULL(DAY_4_PERFORM, 0)  + ISNULL(DAY_5_PERFORM, 0)  + ISNULL(DAY_6_PERFORM, 0)  + ISNULL(DAY_7_PERFORM, 0)  + 
    ISNULL(DAY_8_PERFORM, 0)  + ISNULL(DAY_9_PERFORM, 0)  + ISNULL(DAY_10_PERFORM, 0) + ISNULL(DAY_11_PERFORM, 0) + ISNULL(DAY_12_PERFORM, 0) + ISNULL(DAY_13_PERFORM, 0) + ISNULL(DAY_14_PERFORM, 0) + 
    ISNULL(DAY_15_PERFORM, 0) + ISNULL(DAY_16_PERFORM, 0) + ISNULL(DAY_17_PERFORM, 0) + ISNULL(DAY_18_PERFORM, 0) + ISNULL(DAY_19_PERFORM, 0) + ISNULL(DAY_20_PERFORM, 0) + ISNULL(DAY_21_PERFORM, 0) + 
    ISNULL(DAY_22_PERFORM, 0) + ISNULL(DAY_23_PERFORM, 0) + ISNULL(DAY_24_PERFORM, 0) + ISNULL(DAY_25_PERFORM, 0) + ISNULL(DAY_26_PERFORM, 0) + ISNULL(DAY_27_PERFORM, 0) + ISNULL(DAY_28_PERFORM, 0) + 
    ISNULL(DAY_29_PERFORM, 0) + ISNULL(DAY_30_PERFORM, 0) + ISNULL(DAY_31_PERFORM, 0)
);
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_1_TITLE AS (
    CASE 
        ...
        WHEN ISNULL(DAY_1_PERFORM, 0) = 0 AND ISNULL(DAY_1_ALL, 0) = 0 THEN NULL 
        WHEN DAY_1_PERFORM = DAY_1_ALL THEN CONVERT(VARCHAR, DAY_1_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_1_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_1_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_2_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_2_PERFORM, 0) = 0 AND ISNULL(DAY_2_ALL, 0) = 0 THEN NULL 
        WHEN DAY_2_PERFORM = DAY_2_ALL THEN CONVERT(VARCHAR, DAY_2_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_2_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_2_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_3_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_3_PERFORM, 0) = 0 AND ISNULL(DAY_3_ALL, 0) = 0 THEN NULL 
        WHEN DAY_3_PERFORM = DAY_3_ALL THEN CONVERT(VARCHAR, DAY_3_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_3_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_3_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_4_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_4_PERFORM, 0) = 0 AND ISNULL(DAY_4_ALL, 0) = 0 THEN NULL 
        WHEN DAY_4_PERFORM = DAY_4_ALL THEN CONVERT(VARCHAR, DAY_4_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_4_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_4_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_5_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_5_PERFORM, 0) = 0 AND ISNULL(DAY_5_ALL, 0) = 0 THEN NULL 
        WHEN DAY_5_PERFORM = DAY_5_ALL THEN CONVERT(VARCHAR, DAY_5_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_5_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_5_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_6_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_6_PERFORM, 0) = 0 AND ISNULL(DAY_6_ALL, 0) = 0 THEN NULL 
        WHEN DAY_6_PERFORM = DAY_6_ALL THEN CONVERT(VARCHAR, DAY_6_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_6_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_6_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_7_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_7_PERFORM, 0) = 0 AND ISNULL(DAY_7_ALL, 0) = 0 THEN NULL 
        WHEN DAY_7_PERFORM = DAY_7_ALL THEN CONVERT(VARCHAR, DAY_7_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_7_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_7_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_8_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_8_PERFORM, 0) = 0 AND ISNULL(DAY_8_ALL, 0) = 0 THEN NULL 
        WHEN DAY_8_PERFORM = DAY_8_ALL THEN CONVERT(VARCHAR, DAY_8_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_8_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_8_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_9_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_9_PERFORM, 0) = 0 AND ISNULL(DAY_9_ALL, 0) = 0 THEN NULL 
        WHEN DAY_9_PERFORM = DAY_9_ALL THEN CONVERT(VARCHAR, DAY_9_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_9_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_9_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_10_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_10_PERFORM, 0) = 0 AND ISNULL(DAY_10_ALL, 0) = 0 THEN NULL 
        WHEN DAY_10_PERFORM = DAY_10_ALL THEN CONVERT(VARCHAR, DAY_10_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_10_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_10_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_11_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_11_PERFORM, 0) = 0 AND ISNULL(DAY_11_ALL, 0) = 0 THEN NULL 
        WHEN DAY_11_PERFORM = DAY_11_ALL THEN CONVERT(VARCHAR, DAY_11_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_11_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_11_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_12_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_12_PERFORM, 0) = 0 AND ISNULL(DAY_12_ALL, 0) = 0 THEN NULL 
        WHEN DAY_12_PERFORM = DAY_12_ALL THEN CONVERT(VARCHAR, DAY_12_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_12_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_12_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_13_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_13_PERFORM, 0) = 0 AND ISNULL(DAY_13_ALL, 0) = 0 THEN NULL 
        WHEN DAY_13_PERFORM = DAY_13_ALL THEN CONVERT(VARCHAR, DAY_13_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_13_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_13_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_14_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_14_PERFORM, 0) = 0 AND ISNULL(DAY_14_ALL, 0) = 0 THEN NULL 
        WHEN DAY_14_PERFORM = DAY_14_ALL THEN CONVERT(VARCHAR, DAY_14_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_14_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_14_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_15_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_15_PERFORM, 0) = 0 AND ISNULL(DAY_15_ALL, 0) = 0 THEN NULL 
        WHEN DAY_15_PERFORM = DAY_15_ALL THEN CONVERT(VARCHAR, DAY_15_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_15_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_15_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_16_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_16_PERFORM, 0) = 0 AND ISNULL(DAY_16_ALL, 0) = 0 THEN NULL 
        WHEN DAY_16_PERFORM = DAY_16_ALL THEN CONVERT(VARCHAR, DAY_16_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_16_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_16_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_17_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_17_PERFORM, 0) = 0 AND ISNULL(DAY_17_ALL, 0) = 0 THEN NULL 
        WHEN DAY_17_PERFORM = DAY_17_ALL THEN CONVERT(VARCHAR, DAY_17_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_17_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_17_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_18_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_18_PERFORM, 0) = 0 AND ISNULL(DAY_18_ALL, 0) = 0 THEN NULL 
        WHEN DAY_18_PERFORM = DAY_18_ALL THEN CONVERT(VARCHAR, DAY_18_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_18_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_18_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_19_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_19_PERFORM, 0) = 0 AND ISNULL(DAY_19_ALL, 0) = 0 THEN NULL 
        WHEN DAY_19_PERFORM = DAY_19_ALL THEN CONVERT(VARCHAR, DAY_19_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_19_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_19_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_20_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_20_PERFORM, 0) = 0 AND ISNULL(DAY_20_ALL, 0) = 0 THEN NULL 
        WHEN DAY_20_PERFORM = DAY_20_ALL THEN CONVERT(VARCHAR, DAY_20_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_20_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_20_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_21_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_21_PERFORM, 0) = 0 AND ISNULL(DAY_21_ALL, 0) = 0 THEN NULL 
        WHEN DAY_21_PERFORM = DAY_21_ALL THEN CONVERT(VARCHAR, DAY_21_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_21_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_21_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_22_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_22_PERFORM, 0) = 0 AND ISNULL(DAY_22_ALL, 0) = 0 THEN NULL 
        WHEN DAY_22_PERFORM = DAY_22_ALL THEN CONVERT(VARCHAR, DAY_22_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_22_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_22_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_23_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_23_PERFORM, 0) = 0 AND ISNULL(DAY_23_ALL, 0) = 0 THEN NULL 
        WHEN DAY_23_PERFORM = DAY_23_ALL THEN CONVERT(VARCHAR, DAY_23_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_23_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_23_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_24_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_24_PERFORM, 0) = 0 AND ISNULL(DAY_24_ALL, 0) = 0 THEN NULL 
        WHEN DAY_24_PERFORM = DAY_24_ALL THEN CONVERT(VARCHAR, DAY_24_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_24_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_24_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_25_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_25_PERFORM, 0) = 0 AND ISNULL(DAY_25_ALL, 0) = 0 THEN NULL 
        WHEN DAY_25_PERFORM = DAY_25_ALL THEN CONVERT(VARCHAR, DAY_25_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_25_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_25_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_26_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_26_PERFORM, 0) = 0 AND ISNULL(DAY_26_ALL, 0) = 0 THEN NULL 
        WHEN DAY_26_PERFORM = DAY_26_ALL THEN CONVERT(VARCHAR, DAY_26_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_26_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_26_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_27_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_27_PERFORM, 0) = 0 AND ISNULL(DAY_27_ALL, 0) = 0 THEN NULL 
        WHEN DAY_27_PERFORM = DAY_27_ALL THEN CONVERT(VARCHAR, DAY_27_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_27_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_27_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_28_TITLE AS (
    CASE
        ...
        WHEN ISNULL(DAY_28_PERFORM, 0) = 0 AND ISNULL(DAY_28_ALL, 0) = 0 THEN NULL 
        WHEN DAY_28_PERFORM = DAY_28_ALL THEN CONVERT(VARCHAR, DAY_28_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_28_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_28_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_29_TITLE AS (
    CASE
        WHEN ROW_TYPE = 1 THEN CASE 
            ...
            ELSE '-' 
        END
        WHEN ISNULL(DAY_29_PERFORM, 0) = 0 AND ISNULL(DAY_29_ALL, 0) = 0 THEN NULL 
        WHEN DAY_29_PERFORM = DAY_29_ALL THEN CONVERT(VARCHAR, DAY_29_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_29_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_29_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_30_TITLE AS (
    CASE
        WHEN ROW_TYPE = 1 THEN CASE 
            ...
            ELSE '-' 
        END
        WHEN ISNULL(DAY_30_PERFORM, 0) = 0 AND ISNULL(DAY_30_ALL, 0) = 0 THEN NULL 
        WHEN DAY_30_PERFORM = DAY_30_ALL THEN CONVERT(VARCHAR, DAY_30_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_30_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_30_ALL, 0)) 
    END
)
...
ALTER TABLE dbo.CARE_DIARY_REPORT ADD DAY_31_TITLE AS (
    CASE
        WHEN ROW_TYPE = 1 THEN CASE 
            ...
            ELSE '-' 
        END
        WHEN ISNULL(DAY_31_PERFORM, 0) = 0 AND ISNULL(DAY_31_ALL, 0) = 0 THEN NULL 
        WHEN DAY_31_PERFORM = DAY_31_ALL THEN CONVERT(VARCHAR, DAY_31_ALL) 
        ELSE CONVERT(VARCHAR, ISNULL(DAY_31_PERFORM, 0)) + '/' + CONVERT(VARCHAR, ISNULL(DAY_31_ALL, 0)) 
    END
)
